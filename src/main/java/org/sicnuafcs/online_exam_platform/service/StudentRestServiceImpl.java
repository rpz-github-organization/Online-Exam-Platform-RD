...
public class StudentRestServiceImpl implements StudentRestService {
    ...
    public Student saveStudent(Student student){
        Student student1=new Student(student.getStu_id(),student.getName(),student.getClass_id(),student.getMajor_id(),student.getGrade(),student.getInstitute_id(),student.getSex(),student.getPassword(),student.getQq(),student.getWeixin(),student.getEmail());
